...
function WebFooter() {
  return (
    <footer>
      <Center
        bgGradient="linear(to-r, #020712, #092769)"
        h={{ base: "", md: "", xl: "30rem" }}
      >
        <SimpleGrid
          columns={{ base: "1", pre: "2", lg: "3", xl: "6" }}
          spacing={{ base: "3rem", pre: "4.5rem", xl: "6rem" }}
          color="#FFFFFF87"
          paddingTop={{
            base: "",
            pre: "5rem",
        ...
        >
          <VStack
            paddingTop={{ base: "5rem", pre: "0", xl: "0" }}
            paddingBottom="3rem"
            spacing="2rem"
          >
            <Image
            ...
            <Stack direction="row" color="white" spacing="1rem">
              ...
              <Link to={"https://linkedin.com/in/rodrigohrzm"}>
                <FontAwesomeIcon size="xl" icon={faLinkedinIn} />
              </Link>
              <Link to={"https://twitter.com/rodrigohrzm"}>
                <FontAwesomeIcon size="xl" icon={faTwitter} />
              </Link>
              <Link to={"https://www.instagram.com/rodrigohrzm"}>
                <FontAwesomeIcon size="xl" icon={faInstagram} />
              </Link>
            </Stack>
          </VStack>
          <VStack align="left" spacing="0.66rem">
            <Heading color="white" as="h6" size="md">
              Services
            </Heading>
      ...
      <Center bg="black" padding="0.66rem">
        <Text
          fontWeight="600"
          marginLeft={{ base: "none", md: "-45%", xl: "-45%" }}
          color="white"
          fontSize={{ base: "sm", sm: "md", lg: "md" }}
        >
          AutoCare Hybrid Experts 2023. All rights reserved.
        </Text>
      </Center>
      <Outlet />
    </footer>
