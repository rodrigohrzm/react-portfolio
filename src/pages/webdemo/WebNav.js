      ...
      <nav>
        ...
        >
          <Flex paddingLeft="2rem" justify="left" w="25%">
            <NavLink onClick={onCloseNav} to={"/webdemo"}>
              <Image
                fit="contain"
                w="225px"
                h="60px"
          ...
          <HStack
            ...
            w="50%"
            spacing="1.5rem"
            display={{ base: "none", lg: "flex", lg: "flex" }}
          >
            <NavLink
              style={({ isActive }) => {
          ...
          <NavLink onClick={onToggleNav}>
            <Button
              display={{ base: "flex", lg: "none", lg: "none" }}
              variant="outline"
              colorScheme="twitter"
              size="lg"
              marginRight="1.5rem"
        ...
        <Collapse in={isOpenNav} animateOpacity>
          <Box bg="white" padding="1.5rem" rounded="md" shadow="md">
