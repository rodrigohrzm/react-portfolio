...
function WebCallToAction() {
    return (
      <Box h='auto' bgSize='cover' backgroundPosition='center center' backgroundRepeat="no-repeat" backgroundImage={{ base: (require("../../assets/images/herosmall.jpg")), xl: (require("../../assets/images/herobig.jpg"))}}>
