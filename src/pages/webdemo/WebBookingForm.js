  ...
  return (
    <Center>
      <Flex
        ...
        maxWidth="1200px"
        margin={{ base: "1.5rem", sm: "2rem", md: "3rem", lg: "5rem" }}
      >
        <Image
          borderLeftRadius="8"
          display={{ base: "none", xl: "yes" }}
          align="right top"
          maxWidth="450px"
          fit="scale-down"
          src={require("../../assets/images/bookingpic.jpg")}
        />
        {ShowForm ? (
          <form ref={form} onSubmit={handleSubmit}>
            ...
            <FormControl as="fieldset">
              <SimpleGrid
                padding={{ base: "1rem", sm: "2rem", pre: "3rem" }}
                spacing="2rem"
              ...
              <Center>
                <Button
                  marginTop={{ base: "0", sm: "-1.5rem", lg: "-2rem" }}
                  marginBottom={{ base: "3rem", xl: "0" }}
                  width="250px"
