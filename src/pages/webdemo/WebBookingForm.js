    ...
    return (
      ...
      <Flex borderLeftRadius="8" borderRightRadius="8" boxShadow='2xl' backgroundColor="#ffffff" maxWidth="1200px" margin={{ base: '1.5rem', sm: '2rem', md: '3rem', lg: '5rem' }}>
         ...
         <SimpleGrid padding={{ base: '1rem', sm: '2rem', pre: '3rem' }} spacing="2rem" columns={{ base: 1, pre: 2 }} borderRadius="4px">
            <Box>
               <FormLabel marginBottom="2rem"><Heading paddingLeft='0.25rem' marginBottom="0.5rem" color='#444444' fontWeight='600' as='h4' size='sm'>Car brand</Heading>
               ...
               <FormLabel marginBottom="2rem"><Heading paddingLeft='0.25rem' marginBottom="0.5rem" color='#444444' fontWeight='600' as='h4' size='sm'>Car model</Heading>
               ...
               <FormLabel marginBottom="2rem"><Heading paddingLeft='0.25rem' marginBottom="0.8rem" color='#444444' fontWeight='600' as='h4' size='sm'>Types of repair</Heading>
               ...
               <FormLabel marginBottom="2rem"><Heading paddingLeft='0.25rem' marginBottom="0.5rem" color='#444444' fontWeight='600' as='h4' size='sm'>Describe your car's issue</Heading>
            ...
            <Box>
               <FormLabel marginBottom="2rem"><Heading paddingLeft='0.25rem' marginBottom="0.5rem" color='#444444' fontWeight='600' as='h4' size='sm'>Choose date</Heading>
                  <Input borderColor="#99b3d7" required type="date" id="res-date" value={date} onChange={hourDropdown}/>
               </FormLabel>
               <FormLabel marginBottom="2rem"><Heading paddingLeft='0.25rem' marginBottom="0.5rem" color='#444444' fontWeight='600' as='h4' size='sm'>Choose time</Heading>
               ...
               <FormLabel marginBottom="2rem"><Heading paddingLeft='0.25rem' marginBottom="0.5rem" color='#444444' fontWeight='600' as='h4' size='sm'>Your full name</Heading>
               ...
               <FormLabel marginBottom="2rem"><Heading paddingLeft='0.25rem' marginBottom="0.5rem" color='#444444' fontWeight='600' as='h4' size='sm'>Contact email</Heading>
                  <InputGroup borderColor="#99b3d7">
               ...
               <FormLabel marginBottom="2rem"><Heading paddingLeft='0.25rem' marginBottom="0.5rem" color='#444444' fontWeight='600' as='h4' size='sm'>Phone number</Heading>
                  <InputGroup borderColor="#99b3d7">
