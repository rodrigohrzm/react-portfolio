  ...
  return (
    <aside id="header">
      <header>
        ...
        <p>
          I live under a palm tree, love cars, and crafting is what I do best.
        </p>
      </header>
      <nav id="nav">
        <ul>
          ...
          <li>
            <a
              ...
              className={activeLink === "skills-section" ? "active" : ""}
            >
              My skills
            </a>
          </li>
      ...
      <footer>
        <ul className="icons">
          <li>
            <a
              href="https://linkedin.com/in/rodrigohrzm"
              target="_blank"
          ...
          <li>
            <a
              href="https://github.com/rodrigohrzm"
              target="_blank"
          ...
          <li>
            <a
              href="https://twitter.com/rodrigohrzm"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.instagram.com/rodrigohrzm"
              target="_blank"
